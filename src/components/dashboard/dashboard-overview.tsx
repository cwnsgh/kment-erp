...
export function DashboardOverview() {
  ...
  return (
    <section className="space-y-8">
      {/* 환영 메시지 */}
      <div>
        <h1 className="text-3xl font-bold text-slate-900">케이먼트님, 안녕하세요!</h1>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {summary.map((section) => (
          <div key={section.title} className="relative rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mb-4 text-4xl font-bold text-accent">{section.total}</div>
